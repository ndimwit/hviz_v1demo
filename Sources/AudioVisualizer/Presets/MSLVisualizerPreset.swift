...
private struct MSLMetalViewWithEnvironment: View {
...
private struct MSLMetalView: UIViewRepresentable {
    ...
    class Coordinator: NSObject, MTKViewDelegate {
        ...
        func updateData(
            ...
            if valuesChanged {
                print("MSL Blur Echo: blur=\(blurIntensity), echo=\(echoIntensity), transform=\(colorTransformIntensity)")
            }
